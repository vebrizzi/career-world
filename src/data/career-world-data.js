  ...
  1:[
    ...
    {q:'Perché vuoi lavorare in questo ruolo?',
     a:[
       ...
       {t:'Dico che seguo l\'azienda da tempo e che questo ruolo sembra il passo naturale, anche se non ho ancora un piano dettagliato di cosa farei.',score:1},
       {t:'Rispondo con una versione quasi identica a quella che darei per qualunque ruolo simile in un\'altra azienda.',score:1},
       {t:'Dico che mi serve un lavoro, in generale.',score:0},
     ]},
  ],
  2:[
    {q:'Racconta una decisione tecnica che hai preso da sola, senza supervisione diretta.',
     a:[
       ...
       {t:'Dico che di solito preferisco confermare con qualcuno più senior prima di decidere, per sicurezza.',score:1},
       {t:'Dico che prendo decisioni rapide basandomi sull\'istinto, funziona quasi sempre.',score:0},
     ]},
    ...
    {q:'Hai mai dovuto dare un feedback difficile a un collega o a un junior?',
     a:[
       ...
       {t:'Dico che di solito lo faccio ma sempre in privato, quindi non ho aneddoti condivisibili qui.',score:1},
       {t:'Dico che evito di solito, preferisco che se ne accorgano da soli.',score:0},
     ]},
  ...
  3:[
    {q:'Descrivi una situazione in cui hai dovuto guidare altri senza autorità formale su di loro.',
     a:[
       ...
       {t:'Dico che ho puntato soprattutto sull\'esempio: facendo bene il mio lavoro, gli altri hanno iniziato a seguirmi spontaneamente.',score:1},
       {t:'Dico che generalmente le persone mi seguono naturalmente, senza dover fare granché di specifico.',score:1},
       {t:'Dico che di solito aspetto che qualcuno con autorità formale decida.',score:0},
     ]},
    ...
    {q:'Racconta una decisione impopolare che hai dovuto prendere o comunicare.',
     a:[
       ...
       {t:'Dico che le decisioni impopolari sono normali nel mio ruolo, senza scendere nei dettagli di come le ho gestite.',score:1},
       {t:'Dico che ho evitato di essere io a comunicarla direttamente.',score:0},
     ]},
  ...
  pmi:{
    ...
    2:{q:'Con un ruolo più impegnativo, come pensi di conciliarlo con la famiglia?',
      a:[
        ...
        {t:'Dico che per ora non ho figli, sperando che basti a chiudere il discorso.',score:0},
    ...
    npcs:[
      {
        ...
        outs:{
          assertive:{
            msg:'Hai chiesto chiarezza in modo professionale. +VOICE +CLARITY',
            stat:{
              VOICE:1,
              CLARITY:1
            }
          ...
          passive:{
            msg:'Hai accettato senza chiedere. Il ruolo resterà vago. +ENERGY a breve termine.',
            stat:{
              ENERGY:1
            }
          },
          direct:{
            msg:'Hai nominato il problema direttamente. +RADAR +VOICE',
            stat:{
              RADAR:2,
              VOICE:1
            }
      ...
      },
      {
        ...
        outs:{
          negotiate:{
            msg:'Hai legato il lavoro extra al riconoscimento. +VOICE +NETWORK',
            stat:{
              VOICE:2,
              NETWORK:1
            }
          ...
          accept:{
            msg:'Hai accettato. Probabilmente lo chiederanno ancora. +ENERGY -CLARITY',
            stat:{
              ENERGY:1,
              CLARITY:-1
            }
          ...
          strategic:{
            msg:'Hai preso tempo per valutare. +CLARITY +RADAR',
            stat:{
              CLARITY:2,
              RADAR:1
            }
          ...
          pattern:{
            msg:'Marco non sa dirti se càpita anche ad altri — ma la domanda ti aiuta a verificare se il pattern è sistemico o isolato prima di agire. +RADAR',
            stat:{
              RADAR:2
            }
          }
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai costruito una connessione reale, e imparato una tattica pratica da chi ha già navigato queste situazioni. +NETWORK +RADAR +SKILL',
            stat:{
              NETWORK:2,
              RADAR:1,
              SKILL:1
          ...
          avoid:{
            msg:'Hai evitato il conflitto. Ma hai perso un\'alleata. +ENERGY -NETWORK',
            stat:{
              ENERGY:1,
              NETWORK:-1
            }
          ...
          systemic:{
            msg:'Ambizioso — ma in una PMI senza processi HR strutturati, proporre un "sistema" a una collega, per quanto alleata, può suonare fuori scala. Giulia apprezza l\'intenzione, ma resta vaga sulla fattibilità. +NETWORK',
            stat:{
              NETWORK:1
            }
          },
          map:{
            msg:'Hai costruito il quadro prima di decidere come muoverti. +NETWORK +RADAR',
            stat:{
              NETWORK:1,
              RADAR:2
            }
      ...
      },
      {
        ...
        outs:{
          fast:{
            msg:'Veloce ma rischioso. +ENERGY -SKILL',
            stat:{
              ENERGY:1,
              SKILL:-1
            }
          ...
          rigorous:{
            msg:'Approccio corretto e comunicabile. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
          ...
          context:{
            msg:'Ottima domanda di business. +SKILL +RADAR',
            stat:{
              SKILL:1,
              RADAR:2
            }
          ...
          overengineer:{
            msg:'Tecnicamente solida, ma sproporzionata rispetto al tempo e all\'infrastruttura reali di una PMI con una scadenza a domani. +SKILL -ENERGY',
            stat:{
              SKILL:1,
              ENERGY:-1
            }
    ...
    npcs:[
      {
        ...
        outs:{
          scope:{
            msg:'Hai definito i confini prima di imbarcarsi. +CLARITY +VOICE',
            stat:{
              CLARITY:2,
              VOICE:1
            }
          ...
          enthusiast:{
            msg:'Entusiasmo reale — ma senza confini chiari ti ritroverai a fare tutto. +ENERGY -CLARITY',
            stat:{
              ENERGY:2,
              CLARITY:-1
            }
          ...
          credit:{
            msg:'Hai nominato il problema direttamente. +VOICE +RADAR',
            stat:{
              VOICE:2,
              RADAR:2
            }
          ...
          compromise:{
            msg:'Un compromesso tra l\'entusiasmo e i confini: mantieni energia e ti ritagli un focus. +CLARITY +ENERGY',
            stat:{
              CLARITY:1,
              ENERGY:1
            }
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai imparato una strategia concreta da chi l\'ha già testata su questo founder specifico. +NETWORK +SKILL +RADAR',
            stat:{
              NETWORK:2,
              SKILL:1,
              RADAR:1
          ...
          trust:{
            msg:'La fiducia è importante — ma documentare non è sfiducia. +ENERGY -RADAR',
            stat:{
              ENERGY:1,
              RADAR:-1
            }
          ...
          systemic:{
            msg:'In una cultura che si vanta di "non avere burocrazia", un sistema formale rischia di essere respinto proprio perché somiglia a processo — l\'intenzione è buona, l\'esecuzione probabilmente prematura. +NETWORK',
            stat:{
              NETWORK:1
            }
          },
          quiet:{
            msg:'Cambi il comportamento senza bisogno di un via libera formale. +SKILL +RADAR',
            stat:{
              SKILL:1,
              RADAR:1
            }
      ...
      },
      {
        ...
        outs:{
          redefine:{
            msg:'Hai ridefinito "leadership" con dati concreti. +VOICE +SKILL',
            stat:{
              VOICE:2,
              SKILL:1
            }
          ...
          defer:{
            msg:'Hai ceduto senza verificare se i criteri erano reali. -VOICE -CLARITY',
            stat:{
              VOICE:-1,
              CLARITY:-1
            }
          ...
          criteria:{
            msg:'Hai smontato l\'argomento chiedendo i criteri. +CLARITY +RADAR',
            stat:{
              CLARITY:2,
              RADAR:2
            }
          ...
          mirror:{
            msg:'Luca non ha una risposta chiara — il criterio non è applicato in modo uniforme. +RADAR +VOICE',
            stat:{
              RADAR:2,
              VOICE:1
            }
      ...
      },
      {
        ...
        outs:{
          ml:{
            msg:'Tecnicamente corretto ma rischioso nei tempi. +SKILL',
            stat:{
              SKILL:1
            }
          },
          pragmatic:{
            msg:'Scelta eccellente per un MVP. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
          ...
          strategic:{
            msg:'Pensi come una product manager. +SKILL +RADAR +CLARITY',
            stat:{
              SKILL:1,
              RADAR:2,
              CLARITY:2
          ...
          hybrid:{
            msg:'Il meglio di entrambi i mondi, ma richiede più coordinamento di ciascuna strada presa da sola. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
    ...
    npcs:[
      {
        ...
        outs:{
          concrete:{
            msg:'Hai chiesto criteri concreti su un concetto vago. +CLARITY +VOICE',
            stat:{
              CLARITY:2,
              VOICE:1
            }
          ...
          passive:{
            msg:'Hai accettato un criterio opaco. -CLARITY',
            stat:{
              CLARITY:-1
            }
          },
          research:{
            msg:'Vai alle fonti primarie. +RADAR +NETWORK',
            stat:{
              RADAR:2,
              NETWORK:1
            }
          ...
          evidence:{
            msg:'Hai ancorato un concetto vago a un episodio reale, verificabile. +CLARITY +VOICE',
            stat:{
              CLARITY:2,
              VOICE:1
            }
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai acquisito una strategia trasferibile, la stessa che ha già funzionato per una senior manager in questa gerarchia. +NETWORK +SKILL',
            stat:{
              NETWORK:2,
              SKILL:1
            }
          ...
          systemic:{
            msg:'Proporre una policy di firm da analyst, senza che sia lei a portarla, rischia di leggersi come uscire dal proprio ruolo — l\'idea resta buona, il canale no. +NETWORK',
            stat:{
              NETWORK:1
            }
          },
          fear:{
            msg:'La paura di sembrare "politica" è reale — ma spesso è esattamente quella che ti frena. +ENERGY -VOICE',
            stat:{
              ENERGY:1,
              VOICE:-1
            }
          ...
          cite:{
            msg:'Costruisci credibilità citando una fonte interna riconosciuta. +NETWORK +CLARITY',
            stat:{
              NETWORK:1,
              CLARITY:1
            }
      ...
      },
      {
        ...
        outs:{
          name:{
            msg:'Hai nominato la struttura del problema. +RADAR +VOICE',
            stat:{
              RADAR:2,
              VOICE:1
            }
          ...
          adapt:{
            msg:'L\'adattamento individuale non risolve un problema strutturale. +ENERGY -RADAR',
            stat:{
              ENERGY:1,
              RADAR:-1
            }
          ...
          data:{
            msg:'Stai raccogliendo dati comparativi. +RADAR +CLARITY',
            stat:{
              RADAR:3,
              CLARITY:1
            }
          ...
          criteria:{
            msg:'Rendi il criterio esplicito e verificabile per chiunque, non solo per te. +CLARITY +RADAR',
            stat:{
              CLARITY:2,
              RADAR:1
            }
      ...
      },
      {
        ...
        outs:{
          model_first:{
            msg:'Il modello viene prima delle domande — rischio classico. +SKILL -CLARITY',
            stat:{
              SKILL:1,
              CLARITY:-1
            }
          ...
          business_first:{
            msg:'Approccio corretto. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
          ...
          frame:{
            msg:'Problem framing prima del solving. +SKILL +RADAR +CLARITY',
            stat:{
              SKILL:1,
              RADAR:2,
              CLARITY:2
          ...
          client_expect:{
            msg:'Parti da ciò che il cliente vuole vedere — ma rischi di dover rifare parte del lavoro se le ipotesi iniziali erano sbagliate. +SKILL',
            stat:{
              SKILL:1
            }
          }
...
export const INNER_CRITICS = {
  pmi:{
    ...
    outs:{
      question:{
        msg:'Hai chiesto prove. L\'Inner Critic non ne ha. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
      ...
      believe:{
        msg:'Hai creduto alla voce senza verificare. -VOICE -CLARITY',
        stat:{
          VOICE:-1,
          CLARITY:-1
        }
      ...
      reframe:{
        msg:'Hai riconosciuto il pattern e cercato prove reali. +RADAR +VOICE',
        stat:{
          RADAR:3,
          VOICE:1
        }
      ...
      specifics:{
        msg:'Se non arriva una risposta specifica, la voce non ha basi. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
  ...
  startup:{
    ...
    outs:{
      analyze:{
        msg:'Hai usato l\'Inner Critic come fonte di informazione, non come verità. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
      ...
      believe:{
        msg:'Hai internalizzato il messaggio. -VOICE -RADAR',
        stat:{
          VOICE:-2,
          RADAR:-1
        }
      ...
      reframe:{
        msg:'Hai separato la tua agency dalla struttura sistemica. +RADAR +VOICE',
        stat:{
          RADAR:3,
          VOICE:1
        }
      ...
      evidence:{
        msg:'Hai smontato la premessa con un dato di fatto. +RADAR +VOICE',
        stat:{
          RADAR:2,
          VOICE:1
        }
  ...
  consulenza:{
    ...
    outs:{
      evidence:{
        msg:'Stai usando il pensiero critico contro l\'Inner Critic. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
      ...
      believe:{
        msg:'Hai generalizzato da un singolo evento. -VOICE -CLARITY',
        stat:{
          VOICE:-1,
          CLARITY:-1
        }
      ...
      nuance:{
        msg:'Hai fatto una distinzione importante. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:2
        }
      ...
      ask:{
        msg:'Hai sostituito l\'interpretazione con un dato reale. +VOICE +CLARITY',
        stat:{
          VOICE:2,
          CLARITY:1
        }
  ...
  corporate:{
    ...
    outs:{
      reframe:{
        msg:'Hai distinto tra valutazione e verità. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
      ...
      believe:{
        msg:'Hai internalizzato un\'opinione come fatto. -VOICE -CLARITY',
        stat:{
          VOICE:-1,
          CLARITY:-1
        }
      ...
      action:{
        msg:'Trasformi l\'ansia in azione concreta. +VOICE +CLARITY',
        stat:{
          VOICE:1,
          CLARITY:2
        }
      ...
      direct:{
        msg:'Hai chiesto un criterio concreto invece di indovinarlo. +VOICE +CLARITY +RADAR',
        stat:{
          VOICE:1,
          CLARITY:1,
          RADAR:1
  ...
  piva:{
    ...
    outs:{
      reframe:{
        msg:'Hai ancorato il valore all\'output, non al mercato. +VOICE +CLARITY',
        stat:{
          VOICE:2,
          CLARITY:1
        }
      ...
      believe:{
        msg:'Hai ceduto al confronto verso il basso. -VOICE -NETWORK',
        stat:{
          VOICE:-2,
          NETWORK:-1
        }
      ...
      question:{
        msg:'Hai messo in discussione il benchmark stesso. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
      ...
      track_record:{
        msg:'Usi il tuo dato reale invece di un confronto astratto con sconosciuti. +RADAR +VOICE',
        stat:{
          RADAR:2,
          VOICE:1
        }
  ...
  pa:{
    ...
    outs:{
      data:{
        msg:'Vai ai dati reali invece di affidarti alla percezione. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
      ...
      believe:{
        msg:'Hai creduto alla voce senza evidenza. -VOICE -CLARITY',
        stat:{
          VOICE:-1,
          CLARITY:-1
        }
      ...
      question:{
        msg:'Questioniy il criterio stesso. +RADAR +VOICE',
        stat:{
          RADAR:2,
          VOICE:1
        }
      ...
      baseline:{
        msg:'Confronti con la media reale, non con i colleghi più visibili. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
  ...
  pa2:{
    ...
    outs:{
      counter:{
        msg:'Contraddici con esempi concreti. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
      ...
      own:{
        msg:'Rivendichi le tue ragioni senza doverle giustificare. +VOICE +CLARITY',
        stat:{
          VOICE:2,
          CLARITY:1
        }
      ...
      reframe:{
        msg:'Ridefinisci l\'internazionalizzazione in modo che si adatti al tuo contesto. +CLARITY +SKILL',
        stat:{
          CLARITY:1,
          SKILL:1
        }
      ...
      longterm:{
        msg:'Guardi i dati reali sul lungo periodo invece della narrazione dominante. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
...
export const W3_NPCS = [
  {
    ...
    outs:{
      ask_criteria:{
        msg:'Hai chiesto i criteri. Il sistema di valutazione diventa visibile quando viene interrogato. +VOICE +CLARITY +RADAR',
        stat:{
          VOICE:2,
          CLARITY:1,
          RADAR:2
      ...
      ask_actions:{
        msg:'Approccio pratico — ma accetti criteri opachi. +SKILL',
        stat:{
          SKILL:1
        }
      },
      compare:{
        msg:'Richiedi dati comparativi. +RADAR +VOICE',
        stat:{
          RADAR:3,
          VOICE:1
        }
      ...
      roadmap:{
        msg:'Ti dai un criterio concreto e una scadenza per verificarlo. +CLARITY +VOICE',
        stat:{
          CLARITY:2,
          VOICE:1
        }
  ...
  },
  {
    ...
    outs:{
      learn:{
        msg:'Stai mappando il sistema. +RADAR +NETWORK',
        stat:{
          RADAR:2,
          NETWORK:2
        }
      ...
      challenge:{
        msg:'Nomini il problema strutturale. +VOICE +RADAR',
        stat:{
          VOICE:2,
          RADAR:2
        }
      ...
      direct_ask:{
        msg:'Chiedi direttamente. +NETWORK +VOICE',
        stat:{
          NETWORK:3,
          VOICE:1
        }
      ...
      parallel:{
        msg:'Costruisci una rete alternativa — più lenta a dare risultati visibili, ma non dipende dall\'essere invitata nel circolo giusto. +NETWORK +RADAR',
        stat:{
          NETWORK:2,
          RADAR:1
        }
  ...
  },
  {
    ...
    outs:{
      structure:{
        msg:'Stai costruendo una relazione professionale solida. +NETWORK +CLARITY',
        stat:{
          NETWORK:2,
          CLARITY:1
        }
      ...
      reciprocal:{
        msg:'Pensi in modo sistemico. +NETWORK +RADAR',
        stat:{
          NETWORK:3,
          RADAR:2
        }
      ...
      honest:{
        msg:'Domanda legittima che rafforza la relazione. +NETWORK +VOICE',
        stat:{
          NETWORK:2,
          VOICE:1
        }
      ...
      protect:{
        msg:'Pensi alla relazione come reciproca, non solo a senso unico. +CLARITY +NETWORK',
        stat:{
          CLARITY:1,
          NETWORK:2
        }
  ...
  },
  {
    ...
    outs:{
      push_back:{
        msg:'Hai richiesto trasparenza sui criteri. +VOICE +CLARITY',
        stat:{
          VOICE:2,
          CLARITY:1
        }
      ...
      agency:{
        msg:'Hai rivendicato il diritto di definire i tuoi limiti da sola. +VOICE +RADAR',
        stat:{
          VOICE:2,
          RADAR:1
        }
      ...
      name_it:{
        msg:'Hai nominato il meccanismo — la "protezione" non richiesta. +RADAR +VOICE',
        stat:{
          RADAR:3,
          VOICE:2
        }
      ...
      partial:{
        msg:'Ottieni un coinvolgimento parziale invece di un\'esclusione totale. +VOICE +ENERGY',
        stat:{
          VOICE:1,
          ENERGY:1
        }
  ...
  },
  {
    ...
    outs:{
      intervals:{
        msg:'Soluzione tecnica elegante. +SKILL +CLARITY',
        stat:{
          SKILL:2,
          CLARITY:1
        }
      ...
      align_first:{
        msg:'Problem framing prima del solving. +SKILL +NETWORK +RADAR',
        stat:{
          SKILL:1,
          NETWORK:1,
          RADAR:2
      ...
      document:{
        msg:'Separare responsabilità tecnica da decisione di business è professionalità avanzata. +SKILL +CLARITY +VOICE',
        stat:{
          SKILL:1,
          CLARITY:2,
          VOICE:1
      ...
      average:{
        msg:'Più semplice da comunicare, ma rischia di scontentare tutti allo stesso modo. +SKILL',
        stat:{
          SKILL:1
        }
      }
...
export const W4_NPCS = [
  {
    ...
    outs:{
      hold_price:{
        msg:'Hai ancorato il prezzo senza scusarti. +VOICE +NETWORK',
        stat:{
          VOICE:2,
          NETWORK:1
        }
      ...
      discovery:{
        msg:'Proteggi il tuo tempo con una struttura. +CLARITY',
        stat:{
          CLARITY:1
        }
      },
      ask_terms:{
        msg:'Hai chiesto chiarezza sui rischi prima di accettare. +RADAR +CLARITY +VOICE',
        stat:{
          RADAR:2,
          CLARITY:1,
          VOICE:1
      ...
      references:{
        msg:'Verifichi come si sono comportati con altri prima di esporti tu. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
  ...
  },
  {
    ...
    outs:{
      boundary:{
        msg:'Hai tenuto il confine in modo professionale. +VOICE +ENERGY',
        stat:{
          VOICE:2,
          ENERGY:2
        }
      ...
      partial:{
        msg:'Compromesso ragionevole. +ENERGY -CLARITY',
        stat:{
          ENERGY:1,
          CLARITY:-1
        }
      ...
      accept:{
        msg:'Hai ceduto. Il cliente ha imparato che funziona. -ENERGY -VOICE',
        stat:{
          ENERGY:-2,
          VOICE:-1
        }
      ...
      hard_boundary:{
        msg:'Il confine più netto possibile — ma può costarti la relazione con questo cliente specifico. +ENERGY +VOICE',
        stat:{
          ENERGY:2,
          VOICE:1
        }
  ...
  },
  {
    ...
    outs:{
      join_active:{
        msg:'Entri nella rete con intenzione di dare, non solo ricevere. +NETWORK +ENERGY',
        stat:{
          NETWORK:3,
          ENERGY:1
        }
      ...
      ask_structure:{
        msg:'Vuoi capire le regole prima di impegnarti. +NETWORK +CLARITY',
        stat:{
          NETWORK:2,
          CLARITY:1
        }
      ...
      fear:{
        msg:'La paura della concorrenza è reale — ma le freelance che collaborano guadagnano di più. +RADAR',
        stat:{
          RADAR:2
        }
      },
      observe:{
        msg:'Un passo più lento verso la fiducia reciproca, ma prudente. +CLARITY',
        stat:{
          CLARITY:2
        }
      }
  ...
  },
  {
    ...
    outs:{
      challenge:{
        msg:'Hai nominato il doppio standard direttamente. +VOICE +RADAR',
        stat:{
          VOICE:2,
          RADAR:2
        }
      ...
      metrics:{
        msg:'Hai spostato la conversazione sui dati. +CLARITY +SKILL',
        stat:{
          CLARITY:2,
          SKILL:1
        }
      ...
      team:{
        msg:'Risposta solida — ma hai accettato il framing del problema. +CLARITY',
        stat:{
          CLARITY:1
        }
      },
      proof:{
        msg:'Rispondi con un fatto concreto invece che con una rassicurazione. +SKILL +VOICE',
        stat:{
          SKILL:1,
          VOICE:2
        }
  ...
  },
  {
    ...
    outs:{
      pragmatic:{
        msg:'Soluzione onesta e fattibile nei vincoli. +SKILL +CLARITY',
        stat:{
          SKILL:2,
          CLARITY:1
        }
      ...
      frame_first:{
        msg:'Stai proteggendo il cliente da una soluzione al problema sbagliato. +SKILL +RADAR +CLARITY',
        stat:{
          SKILL:1,
          RADAR:2,
          CLARITY:2
      ...
      honest_risk:{
        msg:'Massima onestà professionale. +VOICE +RADAR +NETWORK',
        stat:{
          VOICE:2,
          RADAR:2,
          NETWORK:1
      ...
      free_audit:{
        msg:'Costruisci credibilità con un investimento — ma è tempo non pagato da bilanciare con gli altri progetti. +SKILL +NETWORK',
        stat:{
          SKILL:1,
          NETWORK:1
        }
...
export const W5_NPCS = [
  {id:'pa_concorso',sprite:'mgr',gender:'f',label:'Commissione Concorso',type:'npc',required:true,gridX:4,gridY:5,
    ...
    outs:{
      ...
      uniform: {msg:'Verifichi se il criterio è applicato in modo uniforme, non solo a te. +RADAR +VOICE',stat:{RADAR:2,VOICE:1}},
    },
  ...
  {id:'pa_burocrazia',sprite:'col',gender:'f',label:'Ufficio IT',type:'npc',required:true,gridX:8,gridY:4,
    ...
    outs:{
      ...
      parallel:   {msg:'Non aspetti passivamente — avanzi su ciò che è già in tuo controllo. +SKILL +CLARITY',stat:{SKILL:1,CLARITY:2}},
    },
  ...
  {id:'pa_sister',sprite:'sis',gender:'f',label:'Mensa universitaria',type:'sis',required:true,gridX:6,gridY:8,
    ...
    outs:{
      ...
      time_check:{msg:'Valuti il carico prima di impegnarti. +CLARITY',stat:{CLARITY:2}},
    },
  ...
  {id:'pa_precariato',sprite:'col',gender:'m',label:'Corridoio università',type:'npc',required:true,gridX:10,gridY:6,
    ...
    outs:{
      explore: {msg:'Con 28 posti l\'anno e 1400 post-doc, esplorare alternative concrete ora è la mossa più realistica per la tua situazione specifica, non una resa. +CLARITY +RADAR +NETWORK',stat:{CLARITY:2,RADAR:1,NETWORK:1}},
      hedge:   {msg:'Costruisci opzioni esterne mantenendo la strada accademica. +NETWORK +CLARITY',stat:{NETWORK:1,CLARITY:2}},
      systemic:{msg:'Impegnarti per riformare un sistema che richiede anni per cambiare è un contributo reale, ma non risolve la tua precarietà nel frattempo — un investimento a lungo termine con un costo immediato di tempo ed energia. +VOICE +RADAR',stat:{VOICE:1,RADAR:2}},
      both:    {msg:'La strategia più completa, ma richiede di gestire due percorsi insieme. +CLARITY +NETWORK +RADAR',stat:{CLARITY:1,NETWORK:1,RADAR:1}},
    },
  ...
  {id:'pa_tech',sprite:'tech',label:'Lab ricerca',type:'tech',required:true,gridX:12,gridY:8,
    ...
    outs:{
      ...
      ethics_board:{msg:'Coinvolgi il presidio istituzionale corretto fin dall\'inizio. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
...
export const PA_ADDITIONS = [
  {id:'pa_pubblicazioni',sprite:'mgr',gender:'m',label:'Meeting gruppo ricerca',type:'npc',required:false,gridX:3,gridY:8,
    ...
    outs:{
      ...
      precedent:{msg:'Impari da un precedente reale invece di ragionare in astratto. +NETWORK +RADAR',stat:{NETWORK:1,RADAR:2}},
    },
  ...
  {id:'pa_trasferimento',sprite:'col',gender:'m',label:'Spin-off meeting',type:'npc',required:false,gridX:12,gridY:4,
    ...
    outs:{
      ...
      read_contract:{msg:'Vai al documento reale prima di ogni altra considerazione. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:1}},
    },
  ...
  {id:'pa_sis2',sprite:'sis',gender:'f',label:'Conferenza internazionale',type:'sis',required:false,gridX:5,gridY:9,
    ...
    outs:{
      ...
      affiliation:   {msg:'Chiarisci un dettaglio che conta per entrambe le istituzioni, fin dall\'inizio. +NETWORK +CLARITY',stat:{NETWORK:1,CLARITY:2}},
    },
  ...
  {id:'pa_tech2',sprite:'tech',label:'Grant writing',type:'tech',required:false,gridX:14,gridY:5,
    ...
    outs:{
      ...
      ncp:            {msg:'Eviti di scrivere un\'intera proposta fuori target. +RADAR +SKILL',stat:{RADAR:2,SKILL:1}},
    },
...
export const PA_LEVEL2_ADDITIONS = [
  {id:'pa_level2_authorship',sprite:'col',gender:'m',label:'Disputa di autorship',type:'npc',level:2,required:false,gridX:4,gridY:2,
    ...
    outs:{
      criteria:{msg:'Usare criteri espliciti e riconosciuti (come la tassonomia CRediT) rende la conversazione fattuale, non personale. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
      concede:{msg:'L\'ordine degli autori pesa concretamente su carriera e citazioni — non è "solo" una formalità. -VOICE',stat:{VOICE:-1}},
      consult:{msg:'Un secondo parere prima di rispondere può aiutare, purché non diventi un modo per evitare la conversazione diretta. +CLARITY +NETWORK',stat:{CLARITY:1,NETWORK:1}},
      institutionalize:{msg:'Ambizioso — risolve il problema per tutti, non solo per te, ma richiede più tempo per essere adottata da tutto il gruppo. +VOICE +RADAR +NETWORK',stat:{VOICE:1,RADAR:1,NETWORK:1}},
    },
  ...
  {id:'pa_level2_procurement',sprite:'tech',label:'Richiesta acquisto attrezzatura',type:'tech',level:2,required:false,gridX:11,gridY:4,
    ...
    outs:{
      cloud:{msg:'Pragmatico, ma il rimborso di spese cloud in ambito pubblico può essere più complicato del previsto — verifica prima le regole. +SKILL',stat:{SKILL:1}},
      scale_down:{msg:'Adattare lo scope alla realtà delle risorse è una competenza sottovalutata nella ricerca pubblica. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:1}},
      collaborate:{msg:'Hai trasformato un vincolo di budget in un\'occasione di collaborazione — spesso la soluzione più sostenibile nella PA. +NETWORK +RADAR',stat:{NETWORK:2,RADAR:2}},
      shared_infra:{msg:'Spesso la risorsa esiste già, solo poco pubblicizzata. +SKILL +NETWORK',stat:{SKILL:1,NETWORK:2}},
    },
...
export const PA_LEVEL3_ADDITIONS = [
  {id:'pa_level3_pi',sprite:'mgr',gender:'f',label:'Coordinamento del progetto',type:'npc',level:3,required:false,gridX:6,gridY:2,
    ...
    outs:{
      mentor_support:{msg:'Cercare supporto strutturato al primo ruolo di coordinamento non è una debolezza — è come si costruisce competenza di leadership in modo sostenibile. +VOICE +NETWORK +RADAR',stat:{VOICE:1,NETWORK:2,RADAR:2}},
      solo:{msg:'Voler dimostrare tutto da sola al primo ruolo di coordinamento aumenta il rischio di errori evitabili. -RADAR',stat:{RADAR:-1}},
      evaluate:{msg:'Valutare il carico realisticamente prima di accettare è una scelta di sostenibilità, non di scarsa ambizione. +CLARITY',stat:{CLARITY:2}},
      workload:{msg:'Chiarisci un dettaglio pratico che spesso resta implicito finché non è troppo tardi. +CLARITY +VOICE',stat:{CLARITY:1,VOICE:2}},
    },
  ...
  {id:'pa_level3_public',sprite:'sis',gender:'f',label:'Intervista pubblica',type:'sis',level:3,required:false,gridX:11,gridY:8,
    ...
    outs:{
      prepare:{msg:'Messaggi chiave preparati in anticipo aiutano a restare centrate anche su temi controversi, senza sembrare artificiali. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
      spontaneous:{msg:'La spontaneità ha valore, ma su temi controversi rischia di lasciare spazio a fraintendimenti o citazioni fuori contesto. +VOICE',stat:{VOICE:1}},
      institutional:{msg:'Coinvolgere l\'ufficio comunicazione è una risorsa istituzionale spesso sottoutilizzata dai singoli ricercatori. +NETWORK +RADAR',stat:{NETWORK:2,RADAR:1}},
      simulate:{msg:'La preparazione più solida, anche se richiede più tempo delle altre opzioni. +SKILL +NETWORK +CLARITY',stat:{SKILL:1,NETWORK:1,CLARITY:1}},
    },
...
export const PA_INNER_CRITICS = [
  {id:'critic',sprite:'crit',
    ...
    outs:{
      ...
      baseline:{msg:'Confronti con la media reale, non con i colleghi più visibili. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:1}},
    },
  ...
  {id:'critic2',sprite:'crit',
    ...
    outs:{
      ...
      longterm:{msg:'Guardi i dati reali sul lungo periodo invece della narrazione dominante. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
...
export const PMI_ADDITIONS = [
  {id:'pmi_ceo',sprite:'mgr',gender:'m',label:'Direzione',type:'npc',required:false,gridX:3,gridY:8,
    ...
    outs:{
      ...
      roadmap:{msg:'Concreto — ma non affronta il fatto che "giovane" non è un criterio oggettivo; utile in aggiunta, non in sostituzione della domanda sui criteri. +CLARITY',stat:{CLARITY:2}},
    },
  ...
  {id:'pmi_cliente',sprite:'col',gender:'m',label:'Call con Cliente',type:'npc',required:false,gridX:11,gridY:4,
    ...
    outs:{
      ...
      accommodate:{msg:'Pragmatico per non perdere la vendita, ma conferma implicitamente il suo pregiudizio. +CLARITY -VOICE',stat:{CLARITY:1,VOICE:-1}},
    },
  ...
  {id:'pmi_sis2',sprite:'sis',gender:'f',label:'Pausa Caffè',type:'sis',required:false,gridX:9,gridY:9,
    ...
    outs:{
      ...
      blunt:   {msg:'Domanda diretta e utile, anche se può suonare brusca in un momento di confidenza. +RADAR',stat:{RADAR:2}},
    },
...
export const PMI_AUTH_ADDITIONS = [
  {id:'pmi_auth_mentor',sprite:'sis',gender:'f',label:'Mentoring Program',type:'sis',authOnly:true,required:false,gridX:7,gridY:3,
    ...
    outs:{
      ask:   {msg:'Hai raccolto una tattica concreta da chi l\'ha già fatto. +NETWORK +CLARITY',stat:{NETWORK:2,CLARITY:1}},
      decline:{msg:'Va bene, ma il mentoring è statisticamente uno dei fattori che più correla con le promozioni. -RADAR',stat:{RADAR:-1}},
      deep:  {msg:'Hai chiesto il "come", non solo il "cosa" — è lì che si impara davvero. +NETWORK +VOICE +RADAR',stat:{NETWORK:2,VOICE:1,RADAR:1}},
      cautious:{msg:'Cauta, ma comunque un passo avanti rispetto a rifiutare. +CLARITY',stat:{CLARITY:2}},
    },
...
export const PMI_LEVEL2_ADDITIONS = [
  {id:'pmi_tier2_budget',sprite:'mgr',gender:'m',label:'Riunione Budget',type:'npc',level:2,required:false,gridX:9,gridY:3,
    ...
    outs:{
      easy:{msg:'Soluzione rapida ma miope — la formazione è spesso la prima vittima e il debito di competenze si paga dopo. -RADAR',stat:{RADAR:-1}},
      balanced:{msg:'Un compromesso ragionevole, ma senza priorità esplicite rischia di indebolire un po\' tutto. +CLARITY',stat:{CLARITY:1}},
      strategic:{msg:'Hai collegato la decisione tecnica a un criterio di business — è così che si guadagna un posto nelle decisioni strategiche. +VOICE +RADAR +CLARITY',stat:{VOICE:2,RADAR:2,CLARITY:1}},
      measure_first:{msg:'Basato su dati reali, ma richiede tempo per raccoglierli che potrebbe non esserci. +SKILL +CLARITY',stat:{SKILL:1,CLARITY:2}},
    },
  ...
  {id:'pmi_tier2_promotion',sprite:'sis',gender:'f',label:'Colloquio di carriera',type:'sis',level:2,required:false,gridX:12,gridY:7,
    ...
    outs:{
      data:{msg:'Ottimo punto di partenza — i dati sono la base, ma le obiezioni arrivano comunque. +SKILL +VOICE',stat:{SKILL:1,VOICE:2}},
      wait:{msg:'Il "merito visto da solo" è uno dei bias più comuni e più costosi per le donne in carriera. -VOICE',stat:{VOICE:-1}},
      prepared:{msg:'Dati più obiezioni anticipate: hai trasformato una richiesta in una trattativa. +VOICE +NETWORK +RADAR',stat:{VOICE:2,NETWORK:1,RADAR:2}},
      precedent:{msg:'Impari da un precedente reale, in aggiunta ai dati. +NETWORK +SKILL',stat:{NETWORK:2,SKILL:1}},
    },
...
export const PMI_LEVEL3_ADDITIONS = [
  {id:'pmi_level3_mentor',sprite:'mgr',gender:'m',label:'Junior in difficoltà',type:'npc',level:3,required:false,gridX:6,gridY:2,
    ...
    outs:{
      investigate:{msg:'Hai separato il segnale dal rumore prima di giudicare — è quello che ci si aspetta da un ruolo senior. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:2}},
      harsh:{msg:'Un giudizio rapido su un dato parziale rischia di far perdere qualcuno che aveva solo bisogno di contesto. -CLARITY',stat:{CLARITY:-1}},
      mentor:{msg:'Hai messo in gioco il tuo tempo per la crescita di un\'altra persona — è così che si costruisce un team, non solo un ruolo. +VOICE +NETWORK +RADAR',stat:{VOICE:1,NETWORK:2,RADAR:2}},
      ask_junior:{msg:'Dai voce a chi è più esposto nella situazione prima di decidere per lui. +VOICE +RADAR',stat:{VOICE:2,RADAR:1}},
    },
  ...
  {id:'pmi_level3_external',sprite:'tech',label:'Crisi con il cliente',type:'tech',level:3,required:false,gridX:11,gridY:9,
    ...
    outs:{
      technical:{msg:'La precisione tecnica rassicura chi capisce il tecnico — ma rischi di perdere chi in call cerca solo risposte pratiche. +SKILL',stat:{SKILL:2}},
      business:{msg:'Hai parlato la lingua di chi ti ascolta prima della tua — è la differenza tra un\'esecutrice e chi guida la relazione col cliente. +VOICE +CLARITY +RADAR',stat:{VOICE:2,CLARITY:1,RADAR:2}},
      apologize:{msg:'Le scuse senza sostanza raramente ricostruiscono fiducia — il cliente vuole sapere cosa succede dopo. -VOICE',stat:{VOICE:-1}},
      prep_together:{msg:'Preparazione solida, anche se aggiunge un ritardo prima della chiamata che il cliente potrebbe notare. +SKILL +CLARITY',stat:{SKILL:1,CLARITY:1}},
    },
...
export const STARTUP_ADDITIONS = [
  {id:'startup_investitore',sprite:'mgr',gender:'m',label:'Pitch room',type:'npc',required:false,gridX:3,gridY:8,
    ...
    outs:{
      ...
      facts_then_private:{msg:'Affronti il merito subito e il bias fuori dalla pressione della call. +SKILL +RADAR',stat:{SKILL:2,RADAR:1}},
    },
  ...
  {id:'startup_burnout',sprite:'col',gender:'m',label:'Stand-up mattutino',type:'npc',required:false,gridX:11,gridY:8,
    dlg:{spk:'😮‍💨 Collega — Luca (esausto)',color:'#ce93d8',
      ...
      chs:[
        ...
        {t:'Dico che sento la stessa pressione, ma che non è detto che "non dire mai di no" sia davvero quello che il founder si aspetta — glielo chiederei direttamente.',out:'question_assumption'},
      ]},
    outs:{
      ...
      question_assumption:{msg:'Metti in discussione l\'assunzione condivisa invece di darla per scontata. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
    },
  ...
  {id:'startup_sis2',sprite:'sis',gender:'f',label:'Terrazza',type:'sis',required:false,gridX:5,gridY:9,
    ...
    outs:{
      ...
      systemic:{msg:'Proporlo prima di aver raccolto abbastanza casi rischia di sembrare prematuro. +NETWORK +RADAR',stat:{NETWORK:1,RADAR:2}},
      scope_check:{msg:'Costruisci il quadro prima di agire. +RADAR +NETWORK',stat:{RADAR:2,NETWORK:1}},
    },
  ...
  {id:'startup_tech2',sprite:'tech',label:'Board meeting',type:'tech',required:false,gridX:14,gridY:5,
    ...
    outs:{
      ...
      competitors:{msg:'Comodo, ma rischia di copiare metriche non adatte al vostro prodotto. +SKILL',stat:{SKILL:1}},
    },
...
export const STARTUP_LEVEL2_ADDITIONS = [
  {id:'startup_level2_scale',sprite:'tech',label:'Sistema che non regge',type:'tech',level:2,required:false,gridX:8,gridY:2,
    ...
    outs:{
      targeted:{msg:'Hai risolto senza destabilizzare il sistema — la scelta più matura sotto pressione. +SKILL +CLARITY',stat:{SKILL:2,CLARITY:1}},
      measure:{msg:'Misurare prima di agire è corretto, ma sotto pressione business rischia di sembrare inazione se non comunicato bene. +SKILL +RADAR',stat:{SKILL:1,RADAR:1}},
      patch:{msg:'Rapido ma rischioso — le patch "temporanee" in produzione diventano spesso permanenti. -CLARITY',stat:{CLARITY:-1}},
      expectations:{msg:'Gestisci le aspettative, ma non risolve da sola il problema tecnico. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
    },
  ...
  {id:'startup_level2_equity',sprite:'mgr',gender:'f',label:'Rinnovo del pacchetto',type:'npc',level:2,required:false,gridX:12,gridY:4,
    ...
    outs:{
      date:{msg:'Una scadenza concreta trasforma un\'intenzione vaga in un impegno verificabile. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
      wait:{msg:'Il "non voglio sembrare interessata ai soldi" è un costo che ricade più spesso sulle donne. -VOICE',stat:{VOICE:-1}},
      benchmark:{msg:'Hai portato dati esterni in una trattativa interna — cambia il potere della conversazione. +VOICE +NETWORK +RADAR',stat:{VOICE:1,NETWORK:1,RADAR:2}},
      writeit:{msg:'Un passo minimo ma concreto. +VOICE +CLARITY',stat:{VOICE:1,CLARITY:2}},
    },
...
export const STARTUP_LEVEL3_ADDITIONS = [
  {id:'startup_level3_hiring',sprite:'mgr',gender:'f',label:'Costruire il team',type:'npc',level:3,required:false,gridX:4,gridY:3,
    ...
    outs:{
      reject:{msg:'Hai scelto la cultura del team come criterio non negoziabile — legittimo, ma senza verifica diretta resta una decisione su sentito dire. +RADAR',stat:{RADAR:1}},
      skills_first:{msg:'Le competenze da sole non prevedono come qualcuno tratterà il team che hai costruito. -CLARITY',stat:{CLARITY:-1}},
      verify:{msg:'Hai verificato di persona prima di decidere — la responsabilità di chi costruisce un team parte da qui. +VOICE +CLARITY +RADAR',stat:{VOICE:1,CLARITY:2,RADAR:2}},
      specifics:{msg:'Trasformi un sentito dire in informazione verificabile. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
  ...
  {id:'startup_level3_board',sprite:'tech',label:'Presentazione al board',type:'tech',level:3,required:false,gridX:13,gridY:8,
    ...
    outs:{
      detail:{msg:'Rigoroso, ma rischi di perdere una board non tecnica nei dettagli implementativi. +SKILL',stat:{SKILL:2}},
      risk_first:{msg:'Aprire con il costo dell\'inazione è una tecnica di comunicazione executive efficace. +VOICE +RADAR',stat:{VOICE:2,RADAR:1}},
      numbers:{msg:'Hai tradotto la complessità tecnica nel linguaggio di chi decide il budget — è la competenza che definisce un Tech Lead. +VOICE +CLARITY +RADAR',stat:{VOICE:2,CLARITY:2,RADAR:1}},
      anticipate:{msg:'Dipende dal founder conoscere davvero bene il board. +SKILL +NETWORK',stat:{SKILL:1,NETWORK:2}},
    },
...
export const CONSULENZA_ADDITIONS = [
  {id:'cons_junior',sprite:'col',gender:'m',label:'Team room',type:'npc',required:false,gridX:3,gridY:8,
    ...
    outs:{
      ...
      redirect:       {msg:'Proteggi il tuo tempo indirizzandolo al canale corretto. +CLARITY +NETWORK',stat:{CLARITY:2,NETWORK:1}},
    },
  ...
  {id:'cons_sis2',sprite:'sis',gender:'f',label:'Sala break',type:'sis',required:false,gridX:8,gridY:9,
    ...
    outs:{
      ...
      optics:  {msg:'Pensi alla percezione esterna prima ancora di entrare. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
  ...
  {id:'cons_tech2',sprite:'tech',label:'Client workshop',type:'tech',required:false,gridX:14,gridY:4,
    ...
    outs:{
      ...
      align_partner:{msg:'Risolvi la fonte del problema prima delle conseguenze col cliente. +VOICE +NETWORK',stat:{VOICE:2,NETWORK:1}},
    },
...
export const CONSULENZA_LEVEL2_ADDITIONS = [
  {id:'cons_level2_pushback',sprite:'col',gender:'m',label:'Cliente scettico',type:'npc',level:2,required:false,gridX:4,gridY:2,
    ...
    outs:{
      cases:{msg:'I casi comparabili danno peso concreto alla raccomandazione. +SKILL +VOICE',stat:{SKILL:1,VOICE:2}},
      listen:{msg:'Capire la resistenza prima di combatterla è spesso la mossa più efficace, non la più debole. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:2}},
      defer:{msg:'Il ruolo di consulente implica prendere posizione, non solo presentare opzioni neutre. -VOICE',stat:{VOICE:-1}},
      pilot:{msg:'Un rischio ridotto abbassa la resistenza al cambiamento. +SKILL +CLARITY',stat:{SKILL:2,CLARITY:1}},
    },
  ...
  {id:'cons_level2_staffing',sprite:'mgr',gender:'m',label:'Assegnazione progetti',type:'npc',level:2,required:false,gridX:11,gridY:4,
    ...
    outs:{
      propose:{msg:'Ti sei proposta attivamente — i progetti ad alta visibilità raramente arrivano da soli. +VOICE +NETWORK',stat:{VOICE:2,NETWORK:1}},
      wait:    {msg:'I risultati non sempre "parlano da soli" — spesso serve chi li racconta. -VOICE',stat:{VOICE:-1}},
      criteria:{msg:'Hai reso visibile un processo spesso informale — utile per te e per chi verrà dopo. +VOICE +RADAR +NETWORK',stat:{VOICE:1,RADAR:2,NETWORK:1}},
      precedent:{msg:'Impari da un precedente reale prima di esporti. +NETWORK +CLARITY',stat:{NETWORK:2,CLARITY:1}},
    },
...
export const CONSULENZA_BRANCH_ADDITIONS = [
  {id:'cons_branch_choice',sprite:'mgr',gender:'m',label:'Colloquio di carriera',type:'npc',level:3,required:false,gridX:8,gridY:6,
    ...
    outs:{
      expert:{msg:'Hai scelto il percorso da Expert. +SKILL +RADAR',stat:{SKILL:2,RADAR:1},track:'expert'},
      manager:{msg:'Hai scelto il percorso da Engagement Manager. +VOICE +NETWORK',stat:{VOICE:1,NETWORK:2},track:'manager'},
    },
...
export const CONSULENZA_LEVEL3_EXPERT_ADDITIONS = [
  {id:'cons_level3_expert',sprite:'tech',label:'Arbitrato tecnico',type:'tech',level:3,track:'expert',required:false,gridX:12,gridY:8,
    ...
    outs:{
      criteria:{msg:'Criteri dichiarati in anticipo rendono l\'arbitrato difendibile e percepito come equo da entrambi i team. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:2}},
      trust:{msg:'La fiducia personale è un dato, ma da sola rischia di sembrare (o essere) favoritismo. -CLARITY',stat:{CLARITY:-1}},
      synthesize:{msg:'Una sintesi ben costruita può risolvere il conflitto alla radice, se il tempo extra è davvero giustificato. +SKILL +CLARITY',stat:{SKILL:2,CLARITY:1}},
      external_review:{msg:'Un secondo parere indipendente rafforza la decisione, ma allunga i tempi. +CLARITY +NETWORK',stat:{CLARITY:2,NETWORK:1}},
    },
...
export const CONSULENZA_LEVEL3_MANAGER_ADDITIONS = [
  {id:'cons_level3_manager',sprite:'sis',gender:'f',label:'Team in difficoltà',type:'sis',level:3,track:'manager',required:false,gridX:5,gridY:3,
    ...
    outs:{
      direct:{msg:'Affrontare direttamente, con esempi, è spesso la via più rispettosa per tutti. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
      structural:{msg:'Hai risolto a livello di sistema, non solo di singolo episodio — previene la ricorrenza. +CLARITY +RADAR +NETWORK',stat:{CLARITY:1,RADAR:2,NETWORK:1}},
      wait:{msg:'Aspettare senza dire nulla lascia che il pattern si consolidi silenziosamente. -RADAR',stat:{RADAR:-1}},
      both:{msg:'Combini le due soluzioni migliori, ma richiede più tempo ed energia. +CLARITY +RADAR +NETWORK',stat:{CLARITY:1,RADAR:1,NETWORK:1}},
    },
...
export const CORPORATE_ADDITIONS = [
  {id:'corp_riunione',sprite:'col',gender:'m',label:'Board prep',type:'npc',required:false,gridX:3,gridY:8,
    ...
    outs:{
      ...
      rehearse:{msg:'Feedback diretto e mirato prima che conti davvero. +SKILL +NETWORK',stat:{SKILL:1,NETWORK:2}},
    },
  ...
  {id:'corp_trasferimento',sprite:'mgr',gender:'f',label:'Offerta HR',type:'npc',required:false,gridX:12,gridY:8,
    ...
    outs:{
      ...
      ignore_personal:{msg:'Protegge i confini, ma non rende visibile il problema come le altre opzioni. +CLARITY',stat:{CLARITY:2}},
    },
  ...
  {id:'corp_sis2',sprite:'sis',gender:'f',label:'Coffee chat',type:'sis',required:false,gridX:8,gridY:9,
    ...
    outs:{
      ...
      consequences:{msg:'Capisci il rischio reale dietro il consiglio, non solo il beneficio. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
  ...
  {id:'corp_tech2',sprite:'tech',label:'Data governance',type:'tech',required:false,gridX:14,gridY:7,
    ...
    outs:{
      ...
      freeze:   {msg:'Massima cautela — ma può rallentare team che dipendono da quei dati. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
...
export const CORPORATE_LEVEL2_ADDITIONS = [
  {id:'corp_level2_visibility',sprite:'col',gender:'m',label:'Riunione cross-team',type:'npc',level:2,required:false,gridX:4,gridY:2,
    ...
    outs:{
      correct:{msg:'Una correzione immediata, fattuale e senza conflitto è spesso la via più efficace. +VOICE +CLARITY',stat:{VOICE:2,CLARITY:1}},
      followup:{msg:'Una nota scritta lascia traccia, anche se il momento in riunione è passato senza reazione. +CLARITY +NETWORK',stat:{CLARITY:1,NETWORK:1}},
      ignore:{msg:'Le micro-appropriazioni non corrette si accumulano — il pattern diventa invisibile proprio perché nessun singolo episodio sembra abbastanza grave. -VOICE',stat:{VOICE:-1}},
      private_first:{msg:'Dai al collega la possibilità di correggersi prima di formalizzare nulla. +VOICE +NETWORK',stat:{VOICE:1,NETWORK:2}},
    },
  ...
  {id:'corp_level2_process',sprite:'tech',label:'Comitato tecnico',type:'tech',level:2,required:false,gridX:12,gridY:4,
    ...
    outs:{
      standard:{msg:'Rispettare il processo ha un costo di tempo ma costruisce credibilità nel sistema. +CLARITY',stat:{CLARITY:2}},
      preempt:{msg:'Anticipare le obiezioni in modo informale accelera senza aggirare il processo. +SKILL +RADAR +VOICE',stat:{SKILL:1,RADAR:2,VOICE:1}},
      workaround:{msg:'Pragmatico, ma una soluzione "meno elegante" per evitare la burocrazia può costare di più nel lungo periodo. +SKILL',stat:{SKILL:1}},
      ask_committee:{msg:'Vai alla fonte per capire il percorso più rapido invece di indovinarlo. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:1}},
    },
...
export const CORPORATE_BRANCH_ADDITIONS = [
  {id:'corp_branch_choice',sprite:'mgr',gender:'f',label:'Piano di carriera',type:'npc',level:3,required:false,gridX:8,gridY:6,
    ...
    outs:{
      expert:{msg:'Hai scelto il percorso da Senior Specialist. +SKILL +RADAR',stat:{SKILL:2,RADAR:1},track:'expert'},
      manager:{msg:'Hai scelto il percorso da Engineering Manager. +VOICE +NETWORK',stat:{VOICE:1,NETWORK:2},track:'manager'},
    },
...
export const CORPORATE_LEVEL3_EXPERT_ADDITIONS = [
  {id:'corp_level3_expert',sprite:'tech',label:'Architecture Review Board',type:'tech',level:3,track:'expert',required:false,gridX:12,gridY:8,
    ...
    outs:{
      against:{msg:'La coerenza degli standard ha valore, ma un "no" rigido senza spiegazione rischia di sembrare burocrazia fine a sé stessa. +RADAR',stat:{RADAR:1}},
      conditional:{msg:'Hai trattato il caso singolo come segnale per migliorare lo standard, non solo come eccezione da concedere o negare. +SKILL +CLARITY +RADAR',stat:{SKILL:1,CLARITY:2,RADAR:1}},
      abstain:{msg:'L\'autorità tecnica comporta la responsabilità di esprimersi, anche nei casi scomodi. -VOICE',stat:{VOICE:-1}},
      sunset_clause:{msg:'Un compromesso solido, ma richiede un meccanismo di follow-up che qualcuno deve poi davvero seguire. +SKILL +CLARITY +RADAR',stat:{SKILL:1,CLARITY:1,RADAR:1}},
    },
...
export const CORPORATE_LEVEL3_MANAGER_ADDITIONS = [
  {id:'corp_level3_manager',sprite:'sis',gender:'f',label:'Colloquio di valutazione',type:'sis',level:3,track:'manager',required:false,gridX:5,gridY:3,
    ...
    outs:{
      balanced:{msg:'Riconoscere i punti di forza rende più ricevibile il feedback sulle aree di miglioramento. +VOICE +CLARITY +NETWORK',stat:{VOICE:1,CLARITY:2,NETWORK:1}},
      skills_only:{msg:'Ignorare l\'impatto sulla collaborazione lascia che il problema si scarichi silenziosamente sul resto del team. -CLARITY',stat:{CLARITY:-1}},
      avoid:{msg:'Rimandare un feedback difficile raramente lo rende più facile — di solito il problema cresce. -VOICE',stat:{VOICE:-1}},
      co_design:{msg:'Un approccio collaborativo, ma richiede più tempo di una soluzione impostata da te. +VOICE +NETWORK +CLARITY',stat:{VOICE:1,NETWORK:1,CLARITY:1}},
    },
...
export const PIVA_ADDITIONS = [
  ...
  {id:'piva_fiscale',sprite:'mgr',gender:'f',label:'Studio commercialista',type:'npc',required:false,gridX:12,gridY:4,
    ...
    outs:{
      ...
      second_opinion:{msg:'Un secondo parere indipendente rafforza la decisione, ma costa tempo e un\'altra consulenza. +RADAR +CLARITY',stat:{RADAR:2,CLARITY:1}},
    },
...
export const PIVA_LEVEL3_ADDITIONS = [
  {id:'piva_level3_hire',sprite:'sis',gender:'f',label:'Prima collaboratrice',type:'sis',level:3,required:false,gridX:5,gridY:3,
    ...
    outs:{
      gradual:{msg:'Un impegno graduale riduce il rischio reciproco ed è una scelta imprenditoriale ragionevole, non un ripiego. +CLARITY +RADAR',stat:{CLARITY:1,RADAR:2}},
      control:{msg:'Trattenere tutto il lavoro di valore per te stessa rende impossibile scalare davvero oltre te stessa. -RADAR',stat:{RADAR:-1}},
      commit:{msg:'Hai fatto il salto da freelance a chi costruisce qualcosa di più grande di sé — con la struttura giusta per farlo funzionare. +VOICE +NETWORK +RADAR',stat:{VOICE:1,NETWORK:2,RADAR:2}},
      trial:{msg:'Un test reciproco a basso rischio prima di un impegno pieno. +CLARITY +RADAR',stat:{CLARITY:2,RADAR:1}},
    },
  ...
  {id:'piva_level3_brand',sprite:'tech',label:'Posizionamento dello studio',type:'tech',level:3,required:false,gridX:12,gridY:8,
    ...
    outs:{
      productize:{msg:'Un toolkit riutilizzabile è ciò che rende un\'offerta trasferibile ad altre persone, non solo replicabile da te. +SKILL +RADAR',stat:{SKILL:2,RADAR:2}},
      custom:{msg:'Il su misura funziona per un freelance solista, ma limita strutturalmente quanto puoi scalare oltre te stessa. +SKILL',stat:{SKILL:1}},
      partial:{msg:'Un buon primo passo, anche se il collo di bottiglia tecnico resta irrisolto nel lungo periodo. +CLARITY',stat:{CLARITY:1}},
      one_type:{msg:'Standardizzi dove conta di più prima di generalizzare. +SKILL +CLARITY',stat:{SKILL:1,CLARITY:2}},
    },
